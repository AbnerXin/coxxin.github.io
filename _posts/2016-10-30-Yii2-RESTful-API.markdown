...
> 16年7月毕业入职，做server开发，公司用的Yii2实现RESTful API， 看了几天Yii2的源码， 总结一下Yii2实现RESTful API流程.

---

#### Catagory

1. [Entry File For Yii2 API](#entry-for-the-application)
2. [Source Code](#source-code)
3. [Yii2 File Tree](#file-tree)
4. [The End](#the-end)
